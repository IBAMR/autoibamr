...
if [ "${IBAMR_VERSION}" = "0.19.0" ]; then
    SAMRAI_VERSION=2025.10.29
elif [ "${IBAMR_VERSION}" = "0.18.0" ]; then
    SAMRAI_VERSION=2025.10.29
elif [ "${IBAMR_VERSION}" = "0.17.0" ]; then
    ...
    cecho ${BAD} "ERROR: at the present time autoibamr only supports IBAMR versions 0.19.0, 0.18.0, 0.17.0, 0.16.0, 0.15.0, 0.14.0, 0.13.0, 0.12.1, 0.12.0, 0.11.0, and 0.10.1."
    exit 1
fi
