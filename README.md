...
2. Use the IBAMR installation directory directly: By default, IBAMR is installed
   in `$HOME/autoibamr/packages/IBAMR-0.13.0/`. You can configure your own IBAMR
   application by running

```bash
   $HOME/autoibamr/packages/cmake-3.20.5/bin/cmake -DIBAMR_ROOT="$HOME/autoibamr/packages/IBAMR-0.13.0/" .
```
...
1. The IBAMR source directory, is, by default, `autoibamr/tmp/unpack/IBAMR-0.13.0/`
   and the build directory is `autoibamr/tmp/build/v0.13.0/`. While this is not
